...
import './Banner.css';
const Banner = ({taskList, resolvedTickets}) => {
    return (
        <div className='w-11/12 mx-auto flex flex-col lg:flex-row gap-10 mt-15'>
            ...
            <div className="banner-1 card w-full lg:w-150 h-48 shadow-sm relative z-0">
                <figure className='flex justify-between'>
                    <img className="object-cover" src="../src/assets/vector1.png" alt=""  />
                    <img className="reverse object-cover" src="../src/assets/vector1.png" alt="" />
                </figure>
